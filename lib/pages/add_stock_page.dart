...
class AddStockPage extends StatefulWidget {
  ...
  const AddStockPage({Key? key, required this.onAdded}) : super(key: key); // added const + key
...
class _AddStockPageState extends State<AddStockPage> {
  ...
  @override
  void dispose() { // <-- ADDED: prevent memory leak
    nameCtrl.dispose();
    qtyCtrl.dispose();
    super.dispose();
  }
  ...
  addStock() async {
    try {
      ...
      await DBHelper.addStock(nameCtrl.text.trim(), qty, unit); // added trim
      widget.onAdded(); // NO AWAIT - VoidCallback is void
      ...
      if(mounted) {
        ...
        await Future.delayed(Duration(milliseconds: 300)); // wait for home to refresh before pop
          ...
          child: Form(
            ...
            child: Column(children: [
              ...
              TextFormField(
                ...
                validator: (v) => v!.trim().isEmpty? 'Enter stock name' : null, // added trim
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton(
                      value: unit, 
                      items: ['kg','Ltrs','Pcs','Bags','USD', 'Others']
              ...
              FilledButton.icon(
                ...
                label: Text('Add Stock', style: TextStyle(fontSize: 16)), 
